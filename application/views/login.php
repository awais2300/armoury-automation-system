...
<head>
  ...
  <title>Armoury Automation System</title>
...
<body class="row img-bg">
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <h1 class="h1 text-grey-900 " style="margin-top:50px; padding:0%; margin-bottom:0px;color:white; text-align:center;text-decoration:underline"><strong> Unit Armoury Automation system </strong></h1>
      <h2 class="h2 text-grey-900 " style="padding:0%; margin-bottom:0px;color:white; text-align:center"><strong>(for weapon issuance and collection)</strong></h2>
      <div class="col-xl-7">
